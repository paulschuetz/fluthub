...
class _$Owner extends Owner {
  ...
  _$Owner._(
    ...
    if (nodeId == null) {
      throw new BuiltValueNullFieldError('Owner', 'nodeId');
    }
    if (avatarUrl == null) {
      throw new BuiltValueNullFieldError('Owner', 'avatarUrl');
    }
    if (url == null) {
      throw new BuiltValueNullFieldError('Owner', 'url');
    }
    if (htmlUrl == null) {
      throw new BuiltValueNullFieldError('Owner', 'htmlUrl');
    }
    if (followersUrl == null) {
      throw new BuiltValueNullFieldError('Owner', 'followersUrl');
    }
    if (followingUrl == null) {
      throw new BuiltValueNullFieldError('Owner', 'followingUrl');
    }
    if (gistsUrl == null) {
      throw new BuiltValueNullFieldError('Owner', 'gistsUrl');
    }
    if (starredUrl == null) {
      throw new BuiltValueNullFieldError('Owner', 'starredUrl');
    }
    if (subscriptionsUrl == null) {
      throw new BuiltValueNullFieldError('Owner', 'subscriptionsUrl');
    }
    if (organizationsUrl == null) {
      throw new BuiltValueNullFieldError('Owner', 'organizationsUrl');
    }
    if (reposUrl == null) {
      throw new BuiltValueNullFieldError('Owner', 'reposUrl');
    }
    if (eventsUrl == null) {
      throw new BuiltValueNullFieldError('Owner', 'eventsUrl');
    }
    if (receivedEventsUrl == null) {
      throw new BuiltValueNullFieldError('Owner', 'receivedEventsUrl');
    }
    if (type == null) {
      throw new BuiltValueNullFieldError('Owner', 'type');
    }
    if (siteAdmin == null) {
      throw new BuiltValueNullFieldError('Owner', 'siteAdmin');
    }
  }
