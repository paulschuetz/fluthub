...
class _$LicenseSerializer implements StructuredSerializer<License> {
  ...
  @override
  Iterable serialize(Serializers serializers, License object,
    ...
    final result = <Object>[
      ...
      'spdx_id',
      serializers.serialize(object.spdxId,
  ...
  @override
  License deserialize(Serializers serializers, Iterable serialized,
      {FullType specifiedType = FullType.unspecified}) {
...
class _$License extends License {
  ...
  factory _$License([void updates(LicenseBuilder b)]) =>
      (new LicenseBuilder()..update(updates)).build();

  _$License._({this.key, this.name, this.spdxId, this.url, this.nodeId})
      : super._() {
    if (key == null) {
      throw new BuiltValueNullFieldError('License', 'key');
    }
    if (name == null) {
      throw new BuiltValueNullFieldError('License', 'name');
    }
    if (spdxId == null) {
      throw new BuiltValueNullFieldError('License', 'spdxId');
    }
    if (url == null) {
      throw new BuiltValueNullFieldError('License', 'url');
    }
    if (nodeId == null) {
      throw new BuiltValueNullFieldError('License', 'nodeId');
    }
  }

  @override
  License rebuild(void updates(LicenseBuilder b)) =>
...
class LicenseBuilder implements Builder<License, LicenseBuilder> {
  ...
  @override
  void update(void updates(LicenseBuilder b)) {
